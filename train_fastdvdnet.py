...
from utils import svd_orthogonalization, close_logger, init_logging, normalize_augment, variable_to_cv2_image
...
def main(**args):
	...
	dataset_val = ValDataset(valsetdir=args['valset_dir'], gtvalsetdir=args['gt_valset_dir'], gray_mode=False)
...
if __name__ == "__main__":
	...
	parser.add_argument("--gt_trainset_dir", type=str, default=None, \
					 help='path of trainset')
	parser.add_argument("--valset_dir", type=str, default=None, \
						 help='path of validation set')
	parser.add_argument("--gt_valset_dir", type=str, default=None, \
						 help='path of ground truth of validation set')
